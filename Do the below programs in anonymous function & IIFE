let arrayNumber = [3, 12, 33, 11, 15, 18, 19, 37, 32, 54, 55, 97, 101]
Print odd numbers in an array
Let resultArray =(let resultArray = (function (arrayNumber) {
...
let stringArray = ["hitesh", 'is', 'a', 'great', 'developer']
...
let arr1 = [8, 9, 10, 12, 16]
let arr2 = [1, 2, 3, 4, 5, 8, 10]
